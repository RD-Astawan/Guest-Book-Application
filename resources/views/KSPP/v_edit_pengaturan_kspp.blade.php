    ...
    <div class="page-inner">
        ...
        <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- Modal -->
                        <form method="post" enctype="multipart/form-data" action="{{ route('update_pengaturan_kspp') }}">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="mb-3 row ml-3">
                                    ...
                                    <div class="col-md-6 p-0">
                                        <input type="text" name="nama_kabag" class="form-control input-full @error('nama_kabag') is-invalid @enderror" value="{{ old('nama_kabag',$data->nama_kabag) }}">
                                        @error('nama_kabag')
                                            <small class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    </div>
