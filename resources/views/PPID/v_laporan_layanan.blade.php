                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-auto">
                                ...
                                <a href="{{ route('set_lap_layanan') }}" class="btn btn-info float-right {{ $check > 0 ? 'disabled' : '' }}">
                                    Cetak Laporan
                                </a>
                            </h2>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatables" class="display table-bordered table table-striped table-hover" >
                                <thead>
                                    <tr>
